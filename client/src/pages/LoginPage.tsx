...
import type { LoginForm } from '../types/index.ts';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="mx-auto h-14 w-14 bg-gray-900 rounded-lg flex items-center justify-center">
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 sm:text-base"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  required
                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 sm:text-base pr-10"
                  placeholder="••••••••"
